...
public final class WindowManager {
    ...
    private Method getAddViewMethod() throws NoSuchMethodException {
        if (addViewMethod == null) {
            addViewMethod = manager.getClass().getMethod("addView");
        }
        return thawRotationMethod;
    }
...
//    }
    ...
    public void addView(View view, ViewGroup.LayoutParams params) {
        try {
            Method method = getAddViewMethod();
            method.invoke(manager, view, params);
        } catch (InvocationTargetException | IllegalAccessException | NoSuchMethodException e) {
            Ln.e("Could not invoke method", e);
        }
    }
